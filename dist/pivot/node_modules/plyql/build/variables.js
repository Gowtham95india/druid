...
function getVariablesDataset() {
    return plywood_1.Dataset.fromJS(variablesData);
}
exports.getVariablesDataset = getVariablesDataset;
function getVariablesFlatDataset() {
    var attributes = [];
    var flatDatum = {};
    for (var _i = 0, variablesData_1 = variablesData; _i < variablesData_1.length; _i++) {
        var variablesDatum = variablesData_1[_i];
        var name_1 = variablesDatum['VARIABLE_NAME'];
        var value = variablesDatum['VARIABLE_VALUE'];
        var type = 'STRING';
        if (value === 'ON' || value === 'OFF') {
            value = value === 'ON';
            type = 'BOOLEAN';
        }
        flatDatum[name_1] = value;
        attributes.push(new plywood_1.AttributeInfo({ name: name_1, type: type }));
    }
    return plywood_1.Dataset.fromJS([flatDatum]);
}
exports.getVariablesFlatDataset = getVariablesFlatDataset;
