...
import { PlyType, DatasetFullType, PlyTypeSingleValue, PlyTypeSimple, Environment } from '../types';
...
import { Dataset, Datum, PlywoodValue, DatasetExternalAlterations } from '../datatypes/index';
...
export declare type ExpressionExternalAlteration = Lookup<ExpressionExternalAlterationSimple | DatasetExternalAlterations>;
...
export declare abstract class Expression implements Instance<ExpressionValue, ExpressionJS> {
    ...
    in(start: Date, end: Date): InExpression;
    in(start: number, end: number): InExpression;
    in(start: string, end: string): InExpression;
    in(ex: any): InExpression;
    overlap(ex: any): OverlapExpression;
    not(): NotExpression;
    ...
    quantile(ex: any, value: number): QuantileExpression;
    ...
    _computeResolvedSimulate(options: ComputeOptions, simulatedQueryGroups: any[][]): PlywoodValue;
    compute(context?: Datum, options?: ComputeOptions): Q.Promise<PlywoodValue>;
    _computeResolved(options: ComputeOptions): Q.Promise<PlywoodValue>;
}
